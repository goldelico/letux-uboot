...
#define CPAPCR_PLLOD0_MASK	BITS_H2L(10, CPAPCR_PLLOD1_LSB)
...
#define CPCCR_SEL_POLL	(0xf << 28)
			...
			/*slect sclk_a; div = 1/8 frq=78M*/
#define DDR_VAL		((1 << 30) | (1 << 29) | (7 << 0))

			/*slect sclk_a; div = 1/16 frq=39M*/
#define MSC0_VAL	((0 << 30) | (1 << 29) | (7 << 0))

			/*slect sclk_a; div = 1/16 frq=39M*/
#define MSC1_VAL	((0 << 30) | (1 << 29) | (7 << 0))

			/*slect sclk_a; div = 1/16 frq=39M*/
#define SFC_VAL		((0 << 30) | (1 << 29) | (15 << 0))
