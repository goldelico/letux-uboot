...
#if (defined(CONFIG_SPL_SFC_SUPPORT) || defined(CONFIG_SPL_SPI_SUPPORT)) && defined (CONFIG_SFC0)
...
#elif (defined(CONFIG_SPL_SFC_SUPPORT) || defined(CONFIG_SPL_SPI_SUPPORT)) && defined (CONFIG_SFC1)
	/*if sfc 9:8[0:1]=1/4 or 9:8[1:0]=1/2  SFC SSICDR[7:0]=>240M(0x4),120M(0x9), 80M(0xe),48M(0x18), 24M(0x31)*/
#if !defined(CONFIG_SFC_ORI_SEL_DF)
