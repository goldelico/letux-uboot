...
*/
#define DDR_tRFC 	DDR__ns(130) /* ns,  AUTO-REFRESH command period. */
//#define DDR_tRFC 	130 /* ns,  AUTO-REFRESH command period. */
#define DDR_tCKESR 	DDR_SELECT_MAX__tCK_ps(3, 15000)     /* Minimum Self-Refresh / Deep-Power-Down , tCK, no */
#define DDR_tXP 	DDR_SELECT_MAX__tCK_ps(2, 7500)   /* EXIT-POWER-DOWN to next valid command period. ns */


#define DDR_tXSR 	DDR_SELECT_MAX__tCK_ps(2, (DDR_tRFC + 10 * 1000)) /* LPDDR2 : Exit self-refresh to next valid command , ns, tXSR */
...
#define DDR_RL  	-1     /* LPDDR2: Read Latency  - DDR__tck(3 4 5 6 7 8) , tck  and -1 is autoselect */
#define DDR_WL		-1 	/* LPDDR2: Write Latency - DDR__tck(1 2 2 3 4 4) , tck  and -1 is autoselect */
