 ...
 */
#define DDR_tRFC    DDR__ns(105) /* ns,  AUTO-REFRESH command period. */
...
#define DDR_RL		DDR__tck(DDR_AL + DDR_CL)
#define DDR_WL		 DDR__tck(DDR_RL - 1)
...
/*#define DDR_tRDLAT	(DDR_RL - DDR__tck(2))*/
/*#define DDR_tWDLAT	DDR__tck(3)*//*(DDR_tWL - 1)*/
#define DDR_tXARD	DDR__tck(3)     /* DDR2 only: Exit active power down to read command , tCK*/
#define DDR_tXARDS	DDR__tck(10 - DDR_AL)/* DDR2 only: Exit active power down to read command (slow exit/low power mode), tCK */
