...
#define DDR_tRP 	DDR_SELECT_MAX__tCK_ps(3, 15 * 1000) /* tRP: PRECHARGE command period to the same bank, wgao DDR_tRPab 8bank?? */
#define DDR_tRCD 	DDR_SELECT_MAX__tCK_ps(3, 15 * 1000) /* ACTIVE to READ or WRITE command period to the same bank. */
...
#define DDR_tWTR 	DDR_SELECT_MAX__tCK_ps(2, 100000)  /* WRITE to READ command delay. */
