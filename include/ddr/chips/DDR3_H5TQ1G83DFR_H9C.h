...
#define DDR_tRP  DDR__ps(13500)  /* tRP: PRECHARGE command period to the same bank. ns*/
#define DDR_tRCD DDR__ps(13500)  /* ACTIVE to READ or WRITE command period to the same bank. ns*/
#define DDR_tRC  DDR__ps(49500)  /* ACTIVE to ACTIVE command period to the same bank. ns*/
