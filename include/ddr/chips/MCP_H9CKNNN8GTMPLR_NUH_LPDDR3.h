...
#define DDR_tRTP 	DDR_SELECT_MAX__tCK_ps(4, 7500)  /* 7.5ns READ to PRECHARGE command period. ???*/
...
#define DDR_tWR 	DDR_SELECT_MAX__tCK_ps(6, 15 * 1000) /* WRITE Recovery Time defined by register MR of DDR2 memory , ns*/
...
#define DDR_tXP 	DDR_SELECT_MAX__tCK_ps(3, 7500)   /* EXIT-POWER-DOWN to next valid command period. ns */
...
#define DDR_RL  	-1/*8*/	/* LPDDR3: Read Latency  - 3 6 8 9 ..., tck*/
#define DDR_WL		-1/*4*/	/* LPDDR3: Write Latency - 1 3 4 5 ..., tck*/
