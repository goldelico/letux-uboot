...
#define DDR_tMRD  	DDR__tck(12)

/*
 * refresh parameters
 */
#define DDR_tRFC 	DDR__ns(210) /* AUTO-REFRESH command period. */
...
#define DDR_tWR 	DDR_SELECT_MAX__tCK_ps(3, 15 * 1000)/* WRITE Recovery Time defined by register MR of DDR2 memory. */
