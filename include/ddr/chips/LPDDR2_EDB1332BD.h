#ifndef __LPDDR2_EDB1332BD_H__
#define __LPDDR2_EDB1332BD_H__
...
*/
#define DDR_tRFCab	DDR__ns(130) /* Refresh cycle time 64-512MB, ns */
...
#define DDR_tMRW	DDR__tck(3)	/* Mode Register Write command period */
...
#define DDR_tAL  	-1	/* Additive Latency, tCK */
#define DDR_RL  	-1 	/* LPDDR2: Read Latency  - 3 4 5 6 7 8 , tck */
#define DDR_WL  	-1 	/* LPDDR2: Write Latency - 1 2 2 3 4 4 , tck */
#define DDR_CL  	-1  /* CAS latency: , LPDDR no */
#define DDR_CWL  	-1  /* CAS Write latency: , LPDDR no */
...
#define DDR_tCKE	DDR__tck(3)

/*
 * LPDDR2 controller refcnt register
 */
#define DDR_tREFI	DDR__ns(78 * 1000)	/* Refresh period */


#endif /* __LPDDR2_EDB1332BD_H__ */
