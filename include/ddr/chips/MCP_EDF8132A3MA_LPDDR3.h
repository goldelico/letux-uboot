...
#define DDR_tWR 	DDR_SELECT_MAX__tCK_ps(3, 15 * 1000)
...
#define DDR_tRFC 	DDR__ns(210)
/* EXIT-POWER-DOWN to next valid command period. */
#define DDR_tXP 	DDR_SELECT_MAX__tCK_ps(2, 7500)
/* EXIT-POWER-DOWN to next valid command period. */
...
#define DDR_tDQSCKMAX   DDR__ps(5500)
