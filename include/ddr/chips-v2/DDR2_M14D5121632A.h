...
#define CONFIG_DDR_DATA_RATE (CONFIG_DDR2_M14D5121632A_MEM_FREQ * 2)

#if((CONFIG_SYS_PLL_FREQ % CONFIG_DDR2_M14D5121632A_MEM_FREQ) ||\
	(CONFIG_SYS_PLL_FREQ / CONFIG_DDR2_M14D5121632A_MEM_FREQ < 0) ||\
	(CONFIG_SYS_PLL_FREQ / CONFIG_DDR2_M14D5121632A_MEM_FREQ > 15))
#error DDR memoryclock division ratio should be an integer between 1 and 16, check CONFIG_SYS_MPLL_FREQ and CONFIG_DDR2_M14D5121632A_MEM_FREQ;
#endif

#if ((CONFIG_DDR_DATA_RATE >= 666000000) &&\
...
#if(-1 == CONFIG_DDR_CL)
#error CONFIG_DDR2_M14D5121632A_MEM_FREQ don't support, check %s\n, check data_rate range
#endif
        ...
        #define CONFIG_DDR2_M14D5121632A_KGD_MR1_DIC       \
...
static inline void DDR2_M14D5121632A_init(void *data)
{
	...
	c->DDR_tRP = DDR_SELECT_MAX__tCK_ps(10,15000);
	c->DDR_tRCD = DDR_SELECT_MAX__tCK_ps(10,15000);
	...
	c->DDR_tFAW = DDR__ns(45);/*NO*/
	c->DDR_tCKE = DDR__tck(5);
	c->DDR_tCKESR = DDR__tck(6);/*NO*/
