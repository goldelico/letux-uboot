...
#ifndef __X2600_DDR3_128M_COMPATIBLE_PARAM_H
#define __X2600_DDR3_128M_COMPATIBLE_PARAM_H
...
#ifndef CONFIG_X2600_DDR3_MEM_FREQ
#define CONFIG_X2600_DDR3_MEM_FREQ CONFIG_SYS_MEM_FREQ
#endif
...
#define CONFIG_DDR_DATA_RATE (CONFIG_X2600_DDR3_MEM_FREQ * 2)

#if((CONFIG_SYS_PLL_FREQ % CONFIG_X2600_DDR3_MEM_FREQ) ||\
	(CONFIG_SYS_PLL_FREQ / CONFIG_X2600_DDR3_MEM_FREQ < 0) ||\
	(CONFIG_SYS_PLL_FREQ / CONFIG_X2600_DDR3_MEM_FREQ > 15))
#error DDR memoryclock division ratio should be an integer between 1 and 16, check CONFIG_SYS_MPLL_FREQ and CONFIG_X2600_DDR3_MEM_FREQ
#endif
...
#if(-1 == CONFIG_DDR_CL)
#error CONFIG_X2600_DDR3_MEM_FREQ don't support, check data_rate range
#endif

#if !defined(CONFIG_X2600_DDR3_KGD_CONFIG) && \
        defined(CONFIG_DDR3_KGD_CONFIG)
        #define CONFIG_X2600_DDR3_KGD_CONFIG            CONFIG_DDR3_KGD_CONFIG
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR0_DLL_RST) && \
        defined(CONFIG_DDR3_KGD_MR0_DLL_RST)
        #define CONFIG_X2600_DDR3_KGD_MR0_DLL_RST       CONFIG_DDR3_KGD_MR0_DLL_RST
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR0_PD) && \
        defined(CONFIG_DDR3_KGD_MR0_PD)
        #define CONFIG_X2600_DDR3_KGD_MR0_PD            CONFIG_DDR3_KGD_MR0_PD
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR1_DLL_EN) && \
        defined(CONFIG_DDR3_KGD_MR1_DLL_EN)
        #define CONFIG_X2600_DDR3_KGD_MR1_DLL_EN        CONFIG_DDR3_KGD_MR1_DLL_EN
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR1_DIC) && \
        defined(CONFIG_DDR3_KGD_MR1_DIC)
        #define CONFIG_X2600_DDR3_KGD_MR1_DIC           CONFIG_DDR3_KGD_MR1_DIC
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR1_RTT_NOM) && \
        defined(CONFIG_DDR3_KGD_MR1_RTT_NOM)
        #define CONFIG_X2600_DDR3_KGD_MR1_RTT_NOM       CONFIG_DDR3_KGD_MR1_RTT_NOM
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR2_RTT_WR) && \
        defined(CONFIG_DDR3_KGD_MR2_RTT_WR)
        #define CONFIG_X2600_DDR3_KGD_MR2_RTT_WR        CONFIG_DDR3_KGD_MR2_RTT_WR
#endif

#if !defined(CONFIG_X2600_DDR3_PHY_DRVODT_CONFIG) && \
        defined(CONFIG_PHY_DRVODT_CONFIG)
        #define CONFIG_X2600_DDR3_PHY_DRVODT_CONFIG     CONFIG_PHY_DRVODT_CONFIG
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PU_DRV_CMD) && \
        defined(CONFIG_PHY_PU_DRV_CMD)
        #define CONFIG_X2600_DDR3_PHY_PU_DRV_CMD        CONFIG_PHY_PU_DRV_CMD
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PD_DRV_CMD) && \
        defined(CONFIG_PHY_PD_DRV_CMD)
        #define CONFIG_X2600_DDR3_PHY_PD_DRV_CMD        CONFIG_PHY_PD_DRV_CMD
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PU_DRV_CK) && \
        defined(CONFIG_PHY_PU_DRV_CK)
        #define CONFIG_X2600_DDR3_PHY_PU_DRV_CK         CONFIG_PHY_PU_DRV_CK
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PD_DRV_CK) && \
        defined(CONFIG_PHY_PD_DRV_CK)
        #define CONFIG_X2600_DDR3_PHY_PD_DRV_CK         CONFIG_PHY_PD_DRV_CK
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PU_DRV_DQ7_0) && \
        defined(CONFIG_PHY_PU_DRV_DQ7_0)
        #define CONFIG_X2600_DDR3_PHY_PU_DRV_DQ7_0      CONFIG_PHY_PU_DRV_DQ7_0
#endif
        ...
        #define CONFIG_X2600_DDR3_PHY_PU_DRV_DQ15_8     CONFIG_PHY_PU_DRV_DQ15_8
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PD_DRV_DQ15_8) && \
        defined(CONFIG_PHY_PD_DRV_DQ15_8)
        #define CONFIG_X2600_DDR3_PHY_PD_DRV_DQ15_8     CONFIG_PHY_PD_DRV_DQ15_8
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PU_ODT_DQ7_0) && \
        defined(CONFIG_PHY_PU_ODT_DQ7_0)
        #define CONFIG_X2600_DDR3_PHY_PU_ODT_DQ7_0      CONFIG_PHY_PU_ODT_DQ7_0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PD_ODT_DQ7_0) && \
        defined(CONFIG_PHY_PD_ODT_DQ7_0)
        #define CONFIG_X2600_DDR3_PHY_PD_ODT_DQ7_0      CONFIG_PHY_PD_ODT_DQ7_0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PU_ODT_DQ15_8) && \
        defined(CONFIG_PHY_PU_ODT_DQ15_8)
        #define CONFIG_X2600_DDR3_PHY_PU_ODT_DQ15_8     CONFIG_PHY_PU_ODT_DQ15_8
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_PD_ODT_DQ15_8) && \
        defined(CONFIG_PHY_PD_ODT_DQ15_8)
        #define CONFIG_X2600_DDR3_PHY_PD_ODT_DQ15_8     CONFIG_PHY_PD_ODT_DQ15_8
#endif

#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_CONFIG) && \
        defined(CONFIG_PHY_DESKEW_CONFIG)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_CONFIG     CONFIG_PHY_DESKEW_CONFIG
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_CMD) && \
        defined(CONFIG_PHY_DESKEW_CMD)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_CMD        CONFIG_PHY_DESKEW_CMD
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_RX_DM0) && \
        defined(CONFIG_PHY_DESKEW_RX_DM0)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_RX_DM0     CONFIG_PHY_DESKEW_RX_DM0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_TX_DM0) && \
        defined(CONFIG_PHY_DESKEW_TX_DM0)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_TX_DM0     CONFIG_PHY_DESKEW_TX_DM0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQ7_0) && \
        defined(CONFIG_PHY_DESKEW_RX_DQ7_0)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQ7_0   CONFIG_PHY_DESKEW_RX_DQ7_0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQ7_0) && \
        defined(CONFIG_PHY_DESKEW_TX_DQ7_0)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQ7_0   CONFIG_PHY_DESKEW_TX_DQ7_0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQS0) && \
        defined(CONFIG_PHY_DESKEW_RX_DQS0)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQS0    CONFIG_PHY_DESKEW_RX_DQS0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQS0) && \
        defined(CONFIG_PHY_DESKEW_TX_DQS0)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQS0    CONFIG_PHY_DESKEW_TX_DQS0
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_RX_DM1) && \
        defined(CONFIG_PHY_DESKEW_RX_DM1)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_RX_DM1     CONFIG_PHY_DESKEW_RX_DM1
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_TX_DM1) && \
        defined(CONFIG_PHY_DESKEW_TX_DM1)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_TX_DM1     CONFIG_PHY_DESKEW_TX_DM1
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQ15_8) && \
        defined(CONFIG_PHY_DESKEW_RX_DQ15_8)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQ15_8  CONFIG_PHY_DESKEW_RX_DQ15_8
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQ15_8) && \
        defined(CONFIG_PHY_DESKEW_TX_DQ15_8)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQ15_8  CONFIG_PHY_DESKEW_TX_DQ15_8
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQS1) && \
        defined(CONFIG_PHY_DESKEW_RX_DQS1)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_RX_DQS1    CONFIG_PHY_DESKEW_RX_DQS1
#endif
#if !defined(CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQS1) && \
        defined(CONFIG_PHY_DESKEW_TX_DQS1)
        #define CONFIG_X2600_DDR3_PHY_DESKEW_TX_DQS1    CONFIG_PHY_DESKEW_TX_DQS1
#endif
        ...
        #define CONFIG_X2600_DDR3_KGD_CONFIG            0x1

#if defined(CONFIG_DDR_DLL_RESET_EN)
        #define CONFIG_X2600_DDR3_KGD_MR0_DLL_RST       0x1
#elif !defined(CONFIG_X2600_DDR3_KGD_MR0_DLL_RST)
        #define CONFIG_X2600_DDR3_KGD_MR0_DLL_RST       0x1
#endif
#if defined(CONFIG_DDR_DLL_OFF)
        #define CONFIG_X2600_DDR3_KGD_MR1_DLL_EN        0x1
        #define CONFIG_X2600_DDR3_KGD_MR0_PD            0x0
#else
#if !defined(CONFIG_X2600_DDR3_KGD_MR1_DLL_EN)
        #define CONFIG_X2600_DDR3_KGD_MR1_DLL_EN        0x0
#endif
#if !defined(CONFIG_X2600_DDR3_KGD_MR0_PD)
        #define CONFIG_X2600_DDR3_KGD_MR0_PD            0x1
#endif
#endif
#if defined(CONFIG_DDR_DRIVER_OUT_STRENGTH)
        #define CONFIG_X2600_DDR3_KGD_MR1_DIC       \
                ((CONFIG_DDR_DRIVER_OUT_STRENGTH_1 << 1) | CONFIG_DDR_DRIVER_OUT_STRENGTH_0)
#elif !defined(CONFIG_X2600_DDR3_KGD_MR1_DIC)
        #define CONFIG_X2600_DDR3_KGD_MR1_DIC           0x1
#endif
#if defined(CONFIG_DDR_CHIP_ODT_VAL) || defined(CONFIG_DDR_CHIP_ODT)
        #define CONFIG_X2600_DDR3_KGD_MR1_RTT_NOM       \
                ((CONFIG_DDR_CHIP_ODT_VAL_RTT_NOM_9 << 2) |   \
                 (CONFIG_DDR_CHIP_ODT_VAL_RTT_NOM_6 << 1) |   \
                 CONFIG_DDR_CHIP_ODT_VAL_RTT_NOM_2)
#elif !defined(CONFIG_X2600_DDR3_KGD_MR1_RTT_NOM)
        #define CONFIG_X2600_DDR3_KGD_MR1_RTT_NOM       0x1
#endif
#if defined(CONFIG_DDR_CHIP_ODT_VAL_RTT_WR)
        #define CONFIG_X2600_DDR3_KGD_MR2_RTT_WR        CONFIG_DDR_CHIP_ODT_VAL_RTT_WR
#elif !defined(CONFIG_X2600_DDR3_KGD_MR2_RTT_WR)
        #define CONFIG_X2600_DDR3_KGD_MR2_RTT_WR        0x0
#endif

#endif

static inline void X2600_DDR3_init(void *data)
{
...
#define X2600_DDR3 {					\
	...
	.type	= DDR3,						\
	.freq	= CONFIG_X2600_DDR3_MEM_FREQ,			\
	.size	= 128,						\
	.init	= X2600_DDR3_init,				\
}
