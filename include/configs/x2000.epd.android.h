 ...
 * MA 02111-1307 USA
 */
#ifndef __X2000_epd_android__
#define __X2000_epd_android__
...
#define CONFIG_SYS_AHB0_FREQ		270000000
#define CONFIG_SYS_AHB2_FREQ		270000000	/*APB = AHB2/2*/
...
#define CONFIG_BOOT_ANDROID 1
#define CONFIG_GPIO_RECOVERY GPIO_PE(25)
...
#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS1,115200 mem=256M@0x0 "
#define CONFIG_BOOTARGS BOOTARGS_COMMON " ip=off root=/dev/ram0 rw rdinit=/init androidboot.hardware=epdbook androidboot.selinux=permissive"
/**
