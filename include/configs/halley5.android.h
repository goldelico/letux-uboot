...
#define CONFIG_GPIO_RECOVERY GPIO_PE(27)
...
#else
#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS3,115200 mem=256M@0x0 mem=256M@0x30000000 "
#endif
  ...
  #else
    #define CONFIG_BOOTARGS BOOTARGS_COMMON " ip=off root=/dev/ram0 rw rdinit=/init androidboot.hardware=halley5 androidboot.selinux=permissive"
  #endif
#else
