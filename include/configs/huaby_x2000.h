...
#define CONFIG_SYS_UART_INDEX		8
...
#define CONFIG_BOOTARGS_MEM_512M		"mem=256M@0x0 mem=256M@0x30000000"
	...
	#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS8,115200 "
#else
	#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS8,115200 mem=128M@0x0 "
#endif
