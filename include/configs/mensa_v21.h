...
#define CONFIG_MDDR_W94AD2KB_JX51
 ...
 */
#define BOOTARGS_COMMON "console=ttyS3,115200n8 mem=128M@0x0 root_wait"
	...
	#define CONFIG_BOOTCOMMAND "tftpboot xxx/uImage; bootm"
		...
		#define CONFIG_BOOTARGS BOOTARGS_COMMON " rootfstype=ext4 root=/dev/mmcblk0p7 rw rootdelay=3"
