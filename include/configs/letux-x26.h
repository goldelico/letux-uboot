...
#define CONFIG_BOOTARGS_AUTO_MODIFY	1	/*auto detect memory size, and modify bootargs for kernel.*/
	...
	#define BOOTARGS_COMMON "ieee754=emulated console=ttyS2,115200"
#else
        #define BOOTARGS_COMMON "ieee754=emulated console=ttyS2,115200 mem=256M@0x0 mem=256M@0x30000000"
#endif
