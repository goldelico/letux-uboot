 ...
 * MA 02111-1307 USA
 */
#ifndef __VIOMIV2000__
#define __VIOMIV2000__
...
#define CONFIG_BOOTARGS_MEM_512M		"mem=256M@0x0 mem=256M@0x30000000"
	...
	#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS1,115200 "
#else
	#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS1,115200 mem=128M@0x0 "
#endif
