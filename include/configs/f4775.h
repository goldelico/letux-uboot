...
#define CONFIG_FPGA		/* Jz4775 FPGA */

#define CONFIG_SYS_APLL_FREQ		30000000
#define CONFIG_SYS_MPLL_FREQ		-1

#define CONFIG_SYS_EXTAL		24000000	/* EXTAL freq: 24 MHz */
#define CONFIG_SYS_HZ			1000 /* incrementer freq */

#define CONFIG_FPGA_H2CLK		24000000
#define CONFIG_SYS_CPU_FREQ		CONFIG_SYS_APLL_FREQ
#define CONFIG_SYS_MEM_DIV		1
...
#define BOOTARGS_COMMON "console=ttyS0,115200 mem=256M@0x0 mem=256M@0x30000000"
	...
	#define	 CONFIG_BOOTARGS BOOTARGS_COMMON " ip=192.168.10.205:192.168.10.1:192.168.10.1:255.255.255.0 nfsroot=192.168.8.3:/home/nfsroot/cli/test-fs rw"
	#define CONFIG_BOOTCOMMAND "tftpboot cli/75/uImage; bootm"
