...
#ifdef CONFIG_JZ_SFC
	[0] = {.pname = "ndxboot",.offset = 0,.size = 256*1024},
	[1] = {.pname = "ndboot",.offset = 256*1024,.size = 3*1024*1024},
	[2] = {.pname = "ndsystem",.offset = 3*1024*1024,.size = 12*1024*1024+32*1024},
#else
