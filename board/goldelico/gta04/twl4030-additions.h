...
#define REG_BCIMDKEY	 (TWL4030_BASEADD_MAIN_CHARGE + 0x001)
...
#define REG_BCIMFEN3	 (TWL4030_BASEADD_MAIN_CHARGE + 0x014)
#define REG_BCIWDKEY	 (TWL4030_BASEADD_MAIN_CHARGE + 0x021)
...
int twl4030_enable_linear_charging(void);
int twl4030_charging_off(void);
