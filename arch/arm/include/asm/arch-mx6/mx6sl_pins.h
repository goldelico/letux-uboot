...
enum {
	...
	MX6_PAD_I2C2_SCL__I2C2_SCL				= IOMUX_PAD(0x0454,0x0164, 0x10,0x724,0x1,0),
	MX6_PAD_I2C2_SDA__I2C2_SDA				= IOMUX_PAD(0x0458,0x0168, 0x10,0x728,0x1,0),

	MX6_PAD_REF_CLK_24M__I2C3_SCL				= IOMUX_PAD(0x052c,0x0224, 0x11,0x72c,0x2,0),
	MX6_PAD_REF_CLK_32K__I2C3_SDA				= IOMUX_PAD(0x0530,0x0228, 0x11,0x730,0x2,0),
