...
#define PXPE		0x60   /* Port Pull Disable Register */
#define PXPES		0x64   /* Port Pull Disable Set Register */
#define PXPEC		0x68   /* Port Pull Disable Clear Register */
...
#define GPIO_PXPE(n)	(GPIO_BASE + (PXPE + (n)*0x100)) /* Port Pull Enable Register */
#define GPIO_PXPES(n)	(GPIO_BASE + (PXPES + (n)*0x100)) /* Port Pull Enable Set Register */
#define GPIO_PXPEC(n)	(GPIO_BASE + (PXPEC + (n)*0x100)) /* Port Pull Enable Clear Register */
#define GPIO_PXPDIR(n)	(GPIO_BASE + (PXPDIR + (n)*0x100)) /* Port Pull Direction Register */
#define GPIO_PXPDIRS(n)	(GPIO_BASE + (PXPDIRS + (n)*0x100)) /* Port Pull Direction Set Register */
#define GPIO_PXPDIRC(n)	(GPIO_BASE + (PXPDIRC + (n)*0x100)) /* Port Pull Direction Clear Register */
