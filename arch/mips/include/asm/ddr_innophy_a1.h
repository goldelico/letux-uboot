...
#define DDRP_INNOPHY_PLL_CTRL		(DDR_PHY_OFFSET + 0x144)
#define DDRP_INNOPHY_PLL_PDIV		(DDR_PHY_OFFSET + 0x148)
#define DDRP_INNOPHY_PLL_PD         (DDR_PHY_OFFSET + 0x14c)
#define DDRP_INNOPHY_DLL_LOCK		(DDR_PHY_OFFSET + 0x104)//not find in fpga config
#define DDRP_INNOPHY_PLL_LOCK		(DDR_PHY_OFFSET + 0x180)
#define DDRP_INNOPHY_CALIB_DONE		(DDR_PHY_OFFSET + 0x184)
#define DDRP_INNOPHY_WL_DONE		(DDR_PHY_OFFSET + DDRP_REG_OFFSET_WL_DONE*4)//not find in fpga config
#define DDRP_INNOPHY_INIT_COMP		(DDR_PHY_OFFSET + 0x110)
#define DDRP_INNOPHY_BIST_RES		(DDR_PHY_OFFSET + 0x118)//not find in fpga config
...
#define DDRP_INNOPHY_CALIB_DELAY_BL_RESULT1	(DDR_PHY_OFFSET + 0x32c)//0xcb left for cyc_dll result
#define DDRP_INNOPHY_CALIB_DELAY_BL_RESULT2	(DDR_PHY_OFFSET + 0x330)//0xcc left for dll and oph result
#define DDRP_INNOPHY_CALIB_DELAY_BH_RESULT1	(DDR_PHY_OFFSET + 0x334)//0xcd right for cyc_dll result
#define DDRP_INNOPHY_CALIB_DELAY_BH_RESULT2	(DDR_PHY_OFFSET + 0x338)//0xce right for dll and oph result
...
#define DDRP_INNOPHY_CALIB_DELAY_BL1	(DDR_PHY_OFFSET + 0x280)//0xa0 only in ddr soft calibration
#define DDRP_INNOPHY_CALIB_DELAY_BL2	(DDR_PHY_OFFSET + 0x284)//0xa1 only in ddr soft calibration
#define DDRP_INNOPHY_CALIB_DELAY_BH1	(DDR_PHY_OFFSET + 0x2c0)//0xb0 only in ddr soft calibration
#define DDRP_INNOPHY_CALIB_DELAY_BH2	(DDR_PHY_OFFSET + 0x2c4)//0xb1 only in ddr soft calibration
#define DDRP_INNOPHY_TRAINING_2c	(DDR_PHY_OFFSET + 0x0b0)//not use,only in dump
#define DDRP_INNOPHY_TRAINING_3c	(DDR_PHY_OFFSET + 0x0f0)//not use,only in dump
#define DDRP_INNOPHY_TRAINING_4c	(DDR_PHY_OFFSET + 0x130)//not use,only in dump
#define DDRP_INNOPHY_TRAINING_5c	(DDR_PHY_OFFSET + 0x170)//not use,only in dump
#define DDRP_WRLEVEL_RESULT_LOW_A	(DDR_PHY_OFFSET + DDRP_REG_OFFSET_WRLEVEL_RESULT_LOW_A*4)//not use
#define DDRP_WRLEVEL_RESULT_LOW_B	(DDR_PHY_OFFSET + DDRP_REG_OFFSET_WRLEVEL_RESULT_LOW_B*4)//not use
#define DDRP_WRLEVEL_RESULT_HIGH_A	(DDR_PHY_OFFSET + DDRP_REG_OFFSET_WRLEVEL_RESULT_HIGH_A*4)//not use
#define DDRP_WRLEVEL_RESULT_HIGH_B	(DDR_PHY_OFFSET + DDRP_REG_OFFSET_WRLEVEL_RESULT_HIGH_B*4)//not use
...
#define ddrp_writel(value, reg)	writel((value), DDRC_BASE+DDR_PHY_OFFSET+reg)
#define ddrp_readl(reg)		readl(DDRC_BASE+DDR_PHY_OFFSET+reg)

/* idx is a sequence num from phy doc */
#define ddrp_writel_byidx(value, idx)	writel((value), DDRC_BASE+DDR_PHY_OFFSET+(idx)*4)
#define ddrp_readl_byidx(idx)		readl(DDRC_BASE+DDR_PHY_OFFSET+(idx)*4)
