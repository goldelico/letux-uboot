...
#ifndef CONFIG_BOARD_SCACHE
 /* There is no SCACHE ops, such as X1000, define These Macros to avoid Compile Error*/
 #define CONFIG_SYS_SCACHE_SIZE          (512 * 1024)
 #define CONFIG_SYS_SCACHELINE_SIZE      (64)
 #define CONFIG_SYS_SCACHE_WAYS          (8)
#endif
...
#define cpu_scache_size()		CONFIG_SYS_SCACHE_SIZE
#define cpu_scache_ways()		CONFIG_SYS_SCACHE_WAYS
#define cpu_scache_waysize()		(CONFIG_SYS_SCACHE_SIZE/CONFIG_SYS_SCACHE_WAYS)
#define cpu_scache_line_size()		CONFIG_SYS_SCACHELINE_SIZE
