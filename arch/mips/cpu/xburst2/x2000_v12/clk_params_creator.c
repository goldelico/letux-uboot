...
struct cgu cgu_clk_sel[CGU_CNT] = {
	...
	[MACPHY] = {1, CPM_MACPHYCDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[MACTX0] = {1, CPM_MACTXCDR0, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[MACTX1] = {1, CPM_MACTXCDR1, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[MACPTP] = {1, CPM_MACPTPCDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	...
	[LCD] = {1, CPM_LPCDR,  30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[MSC0] = {1, CPM_MSC0CDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EXCLK, -1}, 29, 28, 27},
	[MSC1] = {1, CPM_MSC1CDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EXCLK, -1}, 29, 28, 27},
	[MSC2] = {1, CPM_MSC2CDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EXCLK, -1}, 29, 28, 27},
	[SFC] = {1, CPM_SFCCDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[SSI] = {1, CPM_SSICDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[CIM] = {1, CPM_CIMCDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[PWM] = {1, CPM_PWMCDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[ISP] = {1, CPM_ISPCDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[RSA] = {1, CPM_RSACDR, 30, CONFIG_DDR_SEL_PLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
};
