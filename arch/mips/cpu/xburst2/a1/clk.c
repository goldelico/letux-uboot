...
struct cgu cgu_clk_sel[CGU_CNT] = {
	...
	//[MAC1PTPCDR] = {1, CPM_MAC1PTPCDR, 30, EPLL, {APLL, MPLL, VPLL, EPLL}, 29, 28, 27},
	[MSC] = {1, CPM_MSC0CDR, 30, MPLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
	[MSC1] = {0, CPM_MSC1CDR, 30, MPLL, {APLL, MPLL, EPLL, -1}, 29, 28, 27},
