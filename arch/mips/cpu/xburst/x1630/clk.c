...
#ifdef CONFIG_BURNER
	return (unsigned int)((unsigned long)gd->arch.gi->extal *2 * fbdiv / refdiv / fdivq);
#else
	return (unsigned int)((unsigned long)(CONFIG_SYS_EXTAL *2 * fbdiv / refdiv / fdivq));
#endif
}
