...
static void final_fill_div(int cpll, int ddrpll)
{
	...
	pll_cfg.l2div = cpu_pll_freq/l2cache_clk;
        ...
        /* optimize decimal problem */
	(cpu_pll_freq / pll_cfg.l2div) > (Periph_pll_freq / pll_cfg.h0div) * 3/2 ? pll_cfg.l2div += 1 : NULL;
        /* pll_cfg.l2div = (cpu_pll_freq + l2cache_clk - 1)/l2cache_clk; // another method from dsqiu */
