...
minipc_nand_config	:	unconfig
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "Compile NAND boot image for minipc"
	@./mkconfig -a minipc mips mips minipc
	@echo "TEXT_BASE = 0x80100000" > $(obj)board/minipc/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
