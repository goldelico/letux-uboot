...
#define	TCSM_BANK0_PART1			(TCSM_BANK0_PART0 + 2048)		/* SC ARGS :	1792*/
#define TCSM_BANK0_PART2			(TCSM_BANK0_PART1 + 1792)		/* DBG:		256 */
...
#define MCU_TCSM_PDMA_MSG			TCSM_BANK0_PART1
...
#define RSA_KEY_ADDR				(TCSM_BANK1_PART1 + 1024)
